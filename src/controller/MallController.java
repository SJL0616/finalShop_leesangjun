...
import menu_memeber.board.CreateBoard;
import menu_memeber.board.ReadBoard;
import menu_memeber.board.RemoveBoard;
...
public class MallController {
	...
	public void init() {
		...
		mapCont.put("ReadBoard", new ReadBoard());
		mapCont.put("CreateBoard", new CreateBoard());
		mapCont.put("RemoveBoard", new RemoveBoard());
		...
		int result =FileDAO.getInstance().dataLoad();
		if(result != 4) {
